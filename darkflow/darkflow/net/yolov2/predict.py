...
trajectory = []
img = cv2.imread('/home/tim/Robin/Tracking-with-darkflow/darkflow/darkflow/net/yolov2/grid.jpg')
ds = True
try:
...
def draw_2d_trajectory(self, trajectory, id_num):
    for (x, y) in trajectory[id_num]:
        cv2.line(img, (x, y), (x, y), (0, 0, 0), 2, 2, 0)
    ...
    if not self.FLAGS.track:
        ...
        for track in trackers:
            ...
            if self.FLAGS.display or self.FLAGS.saveVideo:
                ...
                draw_trajectory(self, imgcv, bbox, id_num)
        return imgcv